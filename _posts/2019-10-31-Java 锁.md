...
1）StampedLock的功能仅仅只是ReadWriteLock的子集
2）StampedLock不支持重入！！
3）StampedLock的悲观读锁、写锁都不支持条件变量（不符合管程模型）
...
![uml.png](https://upload-images.jianshu.io/upload_images/7190871-fa3552d6b66364b1.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
